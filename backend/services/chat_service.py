...
def process_chat(
    *,
    ...
    try:
        ...
        llm_quality_gate_top = generation.get("llm_quality_gate") if isinstance(generation.get("llm_quality_gate"), dict) else None
        ...
        response_debug: dict[str, Any] = {
            ...
            "final_answer_source": str(generation.get("final_answer_source") or generation_debug.get("final_answer_source") or "") or None,
            "fallback_reason": str(generation.get("fallback_reason") or generation_debug.get("fallback_reason") or "") or None,
            ...
            "above_reference_count": int(generation.get("above_reference_count") or generation_debug.get("above_reference_count") or 0),
            "below_reference_count": int(generation.get("below_reference_count") or generation_debug.get("below_reference_count") or 0),
            "within_reference_count": int(generation.get("within_reference_count") or generation_debug.get("within_reference_count") or 0),
            "needs_clinical_context_count": int(generation.get("needs_clinical_context_count") or generation_debug.get("needs_clinical_context_count") or 0),
            "major_anomalies_count": int(generation.get("major_anomalies_count") or generation_debug.get("major_anomalies_count") or 0),
            "selected_normal_results_count": int(generation.get("selected_normal_results_count") or generation_debug.get("selected_normal_results_count") or 0),
            "requested_doc_id": str(generation.get("requested_doc_id") or generation_debug.get("requested_doc_id") or "") or None,
            "resolved_doc_id": str(generation.get("resolved_doc_id") or generation_debug.get("resolved_doc_id") or "") or None,
            "resolved_filename": str(generation.get("resolved_filename") or generation_debug.get("resolved_filename") or "") or None,
            "resolved_file_hash": str(generation.get("resolved_file_hash") or generation_debug.get("resolved_file_hash") or "") or None,
            "resolved_page_count": generation.get("resolved_page_count") or generation_debug.get("resolved_page_count"),
            "indexed_page_count": generation.get("indexed_page_count") or generation_debug.get("indexed_page_count"),
            "ingestion_timestamp": str(generation.get("ingestion_timestamp") or generation_debug.get("ingestion_timestamp") or "") or None,
            "source_pdf_path": str(generation.get("source_pdf_path") or generation_debug.get("source_pdf_path") or "") or None,
            ...
            "llm_repair_validation_errors": list(generation.get("llm_repair_validation_errors") or generation_debug.get("llm_repair_validation_errors") or generation_debug.get("llm_repaired_validation_errors") or []),
            "llm_repair_truncation_detected": bool(generation.get("llm_repair_truncation_detected") or generation_debug.get("llm_repair_truncation_detected")),
            ...
            response_debug.update(
                {
                    ...
                    "document_identity_status": str(generation.get("document_identity_status") or generation_debug.get("document_identity_status") or "") or None,
                    "document_identity_reasons": list(generation.get("document_identity_reasons") or generation_debug.get("document_identity_reasons") or []),
                    "document_identity_checks": list(generation_debug.get("document_identity_checks") or []),
                    "indexed_source_pdf_path": str(generation_debug.get("indexed_source_pdf_path") or "") or None,
                    "extraction_document_path": str(generation_debug.get("extraction_document_path") or "") or None,
        ...
        return ChatResponse(
            ...
            llm_quality_gate=llm_quality_gate_top,
            final_answer_quality_gate=final_answer_quality_gate_top,
            quality_final_status=quality_final_status_top if quality_final_status_top in {"pass", "warning", "fail"} else None,
            synthesis_quality_reason=synthesis_quality_reason_top,
            ...
            ingestion_timestamp=str(generation.get("ingestion_timestamp") or generation_debug.get("ingestion_timestamp") or "") or None,
            source_pdf_path=str(generation.get("source_pdf_path") or generation_debug.get("source_pdf_path") or "") or None,
            document_identity_mismatch=bool(generation.get("document_identity_mismatch") or generation_debug.get("document_identity_mismatch")) or None,
            document_identity_status=str(generation.get("document_identity_status") or generation_debug.get("document_identity_status") or "") or None,
            document_identity_reasons=list(generation.get("document_identity_reasons") or generation_debug.get("document_identity_reasons") or []),
            visualization=(generation.get("visualization") if isinstance(generation.get("visualization"), dict) else None),
