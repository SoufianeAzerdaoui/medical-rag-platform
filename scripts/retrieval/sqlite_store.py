    ...
    def keyword_search_rows(
        ...
        *,
        ...
        SELECT
          ...
          m.analyte_norm AS analyte_norm,
          m.parameter AS parameter,
          m.parameter_norm AS parameter_norm,
          m.value_raw AS value_raw,
          m.value_numeric AS value_numeric,
          m.unit AS unit,
          m.reference_range AS reference_range,
          m.reference_complexity AS reference_complexity,
          m.interpretation_status AS interpretation_status,
          m.result_kind AS result_kind,
          m.result_quality_status AS result_quality_status,
          m.previous_result_present AS previous_result_present,
          m.previous_result_value_raw AS previous_result_value_raw,
          m.previous_result_value_numeric AS previous_result_value_numeric,
          m.previous_result_unit AS previous_result_unit,
          m.source_kind AS source_kind,
          m.source_table_id AS source_table_id,
